...
public IHttpResponceResult AdminDashboard()
{
    ...
    htmlBuilder.Append("<li><a href='/admin/manage-table?table=comedies'>Комедии</a></li>");
    htmlBuilder.Append("<li><a href='/admin/manage-table?table=dramas'>Драмы</a></li>");
    htmlBuilder.Append("<li><a href='/admin/manage-table?table=fighters'>Боевики</a></li>");
    htmlBuilder.Append("<li><a href='/admin/manage-table?table=movies'>Фильмы</a></li>");
    htmlBuilder.Append("<li><a href='/admin/manage-table?table=series'>Сериалы</a></li>");
    htmlBuilder.Append("</ul>");
...
public IHttpResponceResult AddRow(string table, string title, string image_path, string genre, string year, int id)
{
    ...
    var allowedTables = new[] { "comedies", "dramas", "fighters", "movies", "series" };
